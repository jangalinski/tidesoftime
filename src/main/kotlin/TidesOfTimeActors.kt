...
fun main() = runBlocking {
  ...
  val millis = measureTimeMillis {
    with(game(p1, p2)) {
      ...
      // Round over
      getState().await().also { println("gamestate: $it") }.points.also {
        println("""
      final score:
      p1: ${it.first}
      p2: ${it.second}
  ...
  println("-- game took $millis ms.. wow, i wish i could play tides of time that fast as well even without channels and other stuff. Wait a minute - are you randomly picking cards from your deck?!")
}
